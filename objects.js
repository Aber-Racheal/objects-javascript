...
const people = [
  ...
  const thesePeople = names(people);
...
const groupedProducts = pdtsByCategory(products);
...
//write a function that returns a new array containing the names of all students whose average score is greater than or equal to 85. const students = [
